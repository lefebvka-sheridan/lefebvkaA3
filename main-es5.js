...
var LefebvkaComponent = /** @class */ (function () {
    function LefebvkaComponent() {
        this.mybooks = _assets_data_myBooks__WEBPACK_IMPORTED_MODULE_1__["MYBOOKS"];
    }
    LefebvkaComponent.prototype.ngOnInit = function () {
        this.onButtonClick(0);
    };
    LefebvkaComponent.prototype.onButtonClick = function (index) {
        this.bookPicked = {
